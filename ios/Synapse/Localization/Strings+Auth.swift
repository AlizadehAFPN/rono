...
struct AuthStrings: Sendable {
    ...
    static let en = AuthStrings(
        ...
        register: .init(
            title: "Create your account", subtitle: "Start your institution's Synapse workspace",
    ...
    static let tr = AuthStrings(
        ...
        register: .init(
            title: "Hesabınızı oluşturun", subtitle: "Kurumunuzun Synapse çalışma alanını başlatın",

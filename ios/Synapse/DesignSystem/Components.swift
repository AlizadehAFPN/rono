...
/// The rounded-square Synapse app-icon logo used on auth + onboarding: the
/// "hourglass" synapse graph mark on the brand gradient. Matches the raster app
/// icons and the web `LogoMark` — keep the node geometry in `SynapseGlyph` in
...
struct BrandMark: View {
    ...
    var body: some View {
        ZStack {
            ...
            SynapseGlyph(color: Palette.primaryForeground)

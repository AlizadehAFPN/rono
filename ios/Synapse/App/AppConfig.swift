...
enum APIEnvironment: String, CaseIterable, Codable, Sendable {
    ...
    var baseURL: URL {
        ...
        case .production:
            ...
            return URL(string: "https://synapse.getjanus.dev")!
        case .development:
...
enum AppConfig {
    ...
    private static let envKey = "synapse.api.environment"
    ...
    /// Fully-qualified API base, e.g. https://api.synapse.getjanus.dev/api/v1

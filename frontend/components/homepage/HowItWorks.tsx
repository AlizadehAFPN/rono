          ...
          {steps.map((step, i) => (
            <div key={step.number} className="relative flex gap-7 lg:gap-10">
              ...
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 shrink-0 rounded-xl bg-violet-500/10 border border-violet-500/25 flex items-center justify-center">
                  <span className="text-violet-400 font-bold text-sm font-mono tracking-wide">
                    {step.number}
                  </span>
                </div>
                {i < steps.length - 1 && (
                  <div className="flex-1 w-px bg-gradient-to-b from-violet-500/30 via-violet-500/10 to-transparent mt-3" />
                )}
              </div>
              ...
              <div className={`${i < steps.length - 1 ? "pb-12" : "pb-0"}`}>
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
                  ...
                  <span className="text-violet-400/65 text-xs font-mono">
                    {step.tag}
                  </span>
                </div>
              </div>

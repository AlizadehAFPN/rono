 ...
 * theme and exposed through [LocalSynapseColors] / `MaterialTheme.synapse`.
...
private val LightSynapseColors = SynapseColors(
...
private val DarkSynapseColors = SynapseColors(
...
val LocalSynapseColors = staticCompositionLocalOf { LightSynapseColors }

/** `MaterialTheme.synapse` accessor for the semantic palette. */
val MaterialTheme.synapse: SynapseColors
    @Composable @ReadOnlyComposable get() = LocalSynapseColors.current
...
fun SynapseTheme(
    ...
    androidx.compose.runtime.CompositionLocalProvider(LocalSynapseColors provides synapseColors) {
        MaterialTheme(

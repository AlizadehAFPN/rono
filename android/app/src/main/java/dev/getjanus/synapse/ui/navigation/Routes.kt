...
enum class TopTab(val icon: ImageVector, val labelRes: Int) {
    HOME(Icons.Filled.Home, dev.getjanus.synapse.R.string.nav_home),
    STUDY(Icons.Filled.AutoAwesome, dev.getjanus.synapse.R.string.nav_study),
    DAILY(Icons.Filled.CalendarMonth, dev.getjanus.synapse.R.string.nav_daily),
    PROGRESS(Icons.AutoMirrored.Filled.TrendingUp, dev.getjanus.synapse.R.string.nav_progress),
    PROFILE(Icons.Filled.Person, dev.getjanus.synapse.R.string.nav_profile),
}

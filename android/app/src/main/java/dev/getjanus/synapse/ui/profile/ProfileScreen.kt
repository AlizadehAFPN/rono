package dev.getjanus.synapse.ui.profile
...
import dev.getjanus.synapse.domain.model.Role
import dev.getjanus.synapse.ui.common.Avatar
        ...
        Column(
                ...
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                    Column {
                        ...
                        Pill(
                            ...
                            color = if (user?.emailVerified == true) MaterialTheme.synapse.success else MaterialTheme.synapse.warning,
                        )
                    }
            ...
            AppCard {
                ...
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                    ...
                    MetricBlock(stringResource(R.string.dash_accuracy), formatPercent(stats?.accuracy), color = MaterialTheme.synapse.success)

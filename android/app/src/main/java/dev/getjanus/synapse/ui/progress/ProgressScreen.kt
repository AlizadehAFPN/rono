...
import dev.getjanus.synapse.data.progress.TopicMasteryDto
    ...
    AppCard {
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(horizontalAlignment = Alignment.End) {
                MetricBlock(stringResource(R.string.dash_accuracy), formatPercent(data.accuracy), color = MaterialTheme.synapse.success)
            }
        }
...
private fun TopicRow(topic: TopicMasteryDto) {
    ...
    AppCard {
        Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(horizontalAlignment = Alignment.End) {
                Text(formatPercent(topic.accuracyRate), style = MaterialTheme.typography.titleMedium, color = MaterialTheme.synapse.success)

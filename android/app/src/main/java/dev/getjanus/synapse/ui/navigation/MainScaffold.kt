package dev.getjanus.synapse.ui.navigation
...
import dev.getjanus.synapse.ui.daily.DailyReviewSetupScreen
import dev.getjanus.synapse.ui.dashboard.DashboardScreen
import dev.getjanus.synapse.ui.exam.ExamScreen
import dev.getjanus.synapse.ui.exam.ExamSetupScreen
import dev.getjanus.synapse.ui.profile.ProfileScreen
import dev.getjanus.synapse.ui.progress.ProgressScreen
import dev.getjanus.synapse.ui.settings.ChangePasswordScreen
import dev.getjanus.synapse.ui.settings.DevicesScreen
import dev.getjanus.synapse.ui.settings.SettingsScreen
import dev.getjanus.synapse.ui.study.SessionScreen
import dev.getjanus.synapse.ui.study.StudyScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable<DailyRoute>(
                deepLinks = listOf(navDeepLink { uriPattern = "synapse://daily" }),
            ) {

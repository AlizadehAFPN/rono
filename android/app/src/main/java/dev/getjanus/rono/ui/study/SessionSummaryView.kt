...
import dev.getjanus.rono.core.designsystem.gamification.Confetti
    ...
    Box(Modifier.fillMaxSize()) {
        Column(
            ...
            ProgressRing(
                ...
                size = 168.dp,
                stroke = 12.dp,
                color = MaterialTheme.rono.success,
            ) {
            ...
            AppCard(modifier = Modifier.fillMaxWidth()) {
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                    MetricBlock(stringResource(R.string.summary_correct), summary.itemsCorrect.toString(), color = MaterialTheme.rono.success)
                    MetricBlock(stringResource(R.string.summary_wrong), summary.itemsWrong.toString(), color = MaterialTheme.rono.danger)
...
private fun CaughtUpView(onDone: () -> Unit) {
    Column(
        ...
        Text("✓", style = MaterialTheme.typography.displayLarge, color = MaterialTheme.rono.success)
        Spacer(Modifier.height(Spacing.md))

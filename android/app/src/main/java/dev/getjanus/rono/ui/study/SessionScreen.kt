...
@Composable
private fun FeedbackBanner(result: dev.getjanus.rono.data.practice.AnswerResultDto) {
    val (label, color) = when {
        result.wasSkipped -> stringResource(R.string.session_skipped) to MaterialTheme.colorScheme.onSurfaceVariant
        result.isCorrect -> stringResource(R.string.session_correct) to MaterialTheme.rono.success
        else -> stringResource(R.string.session_incorrect) to MaterialTheme.rono.danger
    }
